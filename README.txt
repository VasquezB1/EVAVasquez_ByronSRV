...
a persistence unit "Evaluacion2Vasquez_BFPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/edu/ups/Evaluacion2Vasquez_BF/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "Evaluacion2Vasquez_BF/pom.xml":
...
artifact ("Evaluacion2Vasquez_BF.war") is already built. You can build
