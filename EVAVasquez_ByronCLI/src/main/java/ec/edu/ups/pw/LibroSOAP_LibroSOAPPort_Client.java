 ...
 * 2022-02-01T11:47:25.511-05:00
 * Generated source version: 3.5.0
 *
 */
public final class LibroSOAP_LibroSOAPPort_Client {

    private static final QName SERVICE_NAME = new QName("http://bean.EVAVasquez_ByronSRV.ups.edu.ec/", "LibroSOAPService");

    private LibroSOAP_LibroSOAPPort_Client() {
    }

    public static void main(String args[]) throws java.lang.Exception {
        URL wsdlURL = LibroSOAPService.WSDL_LOCATION;
        ...
        LibroSOAPService ss = new LibroSOAPService(wsdlURL, SERVICE_NAME);
        LibroSOAP port = ss.getLibroSOAPPort();
